    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-purple via-purple to-dark-purple">
      ...
      <div className="container mx-auto px-4 pt-16">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-screen">
          ...
          {/* Right Form */}
          <div className="bg-black/40 backdrop-blur-sm p-8 rounded-2xl border border-purple/30 glow">
            ...
            <form className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full p-4 bg-dark-purple/50 border border-purple/50 rounded-lg text-white placeholder-gray-400 focus:border-neon-pink focus:outline-none transition-colors"
                />
              </div>
              ...
              <div>
                <select className="w-full p-4 bg-dark-purple/50 border border-purple/50 rounded-lg text-white focus:border-neon-pink focus:outline-none transition-colors">
              ...
              <div>
                <textarea 
                  ...
                  rows={3}
                  className="w-full p-4 bg-dark-purple/50 border border-purple/50 rounded-lg text-white placeholder-gray-400 focus:border-neon-pink focus:outline-none transition-colors resize-none"
                ></textarea>
              </div>
              
              <button 
                type="submit"
                className="w-full bg-gradient-to-r from-neon-green to-purple hover:from-purple hover:to-neon-green text-white font-bold py-4 rounded-lg transition-all duration-300 glow-green transform hover:scale-105"
              >
                Enviar Solicitud
              </button>
            </form>
